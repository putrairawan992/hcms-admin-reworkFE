...
import { DataTalentCard, HistoryTalentCard, BiodataField, AttachmentFileList } from "../../components/molecules";
    ...
    <Box className={styles["inbox-container"]}>
      ...
      <Flex marginBottom={4} marginTop={10}>
        <Box paddingX={2} paddingY={2}>
          <Image src="https://api-hcms.productscala.online/public/upload/1727253276975PasPhoto_MeililaSyavira.png" height={200} width={150} />
          <Button style={style.button} marginTop={2}>Send Message</Button>
        ...
        <Box marginRight={2} paddingX={2} paddingY={2} flex={1} marginLeft={12}>
          ...
          <BiodataField title="Tempat Tanggal Lahir" value={data?.place_birth} additionalValue="28 December 1999" />
          ...
          <BiodataField title="Emergency Contact" value={data?.emergency_name} additionalValue={data?.emergency_number} extraValue={data?.emergency_status} />
        </Box>
      </Flex>
      <Box marginRight={2} paddingX={2} paddingY={2} flex={1}>
        ...
        <BiodataField title="Alamat Domisili" value={data?.residential_address} />
        <BiodataField title="Alamat Rumah (KTP)" value={data?.address_on_identity_card} />
        <BiodataField title="Nomor NIK" value={data?.company_registration_number} />
        ...
        <BiodataField title="No. Rek Bank" value={data?.bank_account_name} additionalValue={data?.bank_account_number} extraValue={data?.bank_name} />
      ...
      <Box marginRight={2} paddingX={2} paddingY={2} flex={1}>
        {data?.experience_job_seeker?.map((item) => (
          <Box marginBottom={6}>
            ...
            <BiodataField title="" value={item?.department} additionalValue={item?.employment_contract} />
            <BiodataField title="" value={`${formatDate(item?.start_working)} - ${formatDate(item?.end_working)}`} additionalValue={item?.location} />
          </Box>
        ))}
      </Box>
      <Box borderWidth={1} borderColor='#AE445A' marginY={6} />
      <Box marginRight={2} paddingX={2} paddingY={2} flex={1}>
        {data?.education_job_seeker?.map((item) => (
          <Box marginBottom={6}>
            ...
            <BiodataField title="" value={item?.education_program} additionalValue={item?.degree} />
            <BiodataField title="" value={`${formatDate(item?.start_study)} - ${formatDate(item?.end_study)}`} additionalValue={item?.ipk} />
          </Box>
        ))}
      </Box>
      <Box borderWidth={1} borderColor='#AE445A' marginY={6} />
      <Box marginRight={2} paddingX={2} paddingY={2} flex={1}>
        {data?.certificate_job_seeker?.map((item) => (
          <Box marginBottom={6}>
            ...
            <BiodataField title="" value={item?.scores} additionalValue={item?.certificate_year} />
          </Box>
        ))}
      </Box>
      <Box borderWidth={1} borderColor='#AE445A' marginY={6} />
