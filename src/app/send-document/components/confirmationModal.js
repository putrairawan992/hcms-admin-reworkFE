...
const ConfirmationModal = ({ isOpen = false, onClose = false, size = 'sm', onSubmit = noop }) => {
      ...
      <ModalContent>
        <ModalBody className={styles['modal-wrapper']}>
          <Box style={{ padding: '12px' }}>
            ...
            <Gap height={6} />
            <Text className={styles['modal-text']}>Apakah Kamu yakin ingin menghapus karyawan ini?</Text>
            <Gap height={6} />
