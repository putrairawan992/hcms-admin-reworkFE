        ...
        {!isPending && (
          <Box className={styles['approval-remuneration-container']}>
            <Flex className={styles['approval-remuneration-details-header']}>
              ...
              >
                <Button
                  onClick={() => openNoteModalHandler('Anda menolak Pengajuan Remunerasi Digital Produk A. Berikan umpan balik pada  Pengajuan Remunerasi Digital Produk A (*wajib)', false)}
                  className={styles['approval-remuneration-content-btn']}
                >
                  Reject
                </Button>
                <Button
                  onClick={() => openNoteModalHandler('Anda menyetujui Pengajuan Remunerasi Digital Produk A. Berikan umpan balik/catatan pada  Pengajuan Remunerasi Digital Produk A (*opsional)', true)}
                  className={styles['approval-remuneration-content-btn']}
                >
                  Accept
                </Button>
