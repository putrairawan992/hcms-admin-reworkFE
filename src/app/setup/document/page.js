...
const SetupDocument = () => {
  const { form, productDigitalData, onHandlePress, onHandleSubmit, onHandleChange } = useDocument();
  ...
  return (
    <Box className={styles["inbox-container"]}>
      <Flex align={"center"} justify={"space-between"}>
        ...
        <Box>
          <Button onClick={() => onHandleSubmit()} className={styles["inbox-btn"]} disabled={true}>
            Continue
          </Button>
        </Box>
      </Flex>
