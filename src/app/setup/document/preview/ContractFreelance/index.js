    ...
    <Box flex={1} height="100%" paddingX={8} paddingY={4}>
      ...
      <Flex>
        ...
        <Flex flex={1}>
          ...
          <Text
            fontSize={12}
          >{`{Rp {Take Home Pay)}, - / bulan (Rincian Gaji Pokok Rp {Gaji Pokok (Angka)}, - dan Tunj. Posisi Rp {Tunj. Posisi (Angka)}, -)}`}</Text>
        </Flex>
      </Flex>
      <Flex>
        <Text flex={0.2} fontSize={12}>
        ...
        <Flex flex={1}>
          ...
          <Text
            fontSize={12}
          >{`Freelance {Awal Kontrak} S.d {Akhir Kontrak}`}</Text>
        </Flex>
      </Flex>
      <Flex>
        <Text flex={0.2} fontSize={12}>
      ...
      <Flex>
        ...
        <Text fontSize={12} flex={1}>
          BPJS Ketenagakerjaan Bukan Penerima Upah yang diaktivasi oleh
          perusahaan akan dibayarkan oleh perusahaan
        </Text>
      </Flex>
      <Gap height={4} />
      <Text fontSize={12}>
