...
import { ChooseLogo, PenilaianDocumentCard, PenilaianMultipleChoiceCard, QuestionSection } from "../../components/molecules";
    ...
    <Box className={styles["inbox-container"]}>
      ...
      <Box flex={1}>
        <Box flex={1} alignItems='center'>
          <Text color='#404041' fontWeight={700} fontSize={16}>Soal dan Jawaban</Text>
          <Gap height={4} />
      ...
      <Flex flex={1} justify='flex-end'>
        <Button className={styles["inbox-btn"]} onClick={addRowQuestion} paddingX={10}>Save</Button>
      </Flex>
    </Box>
  );
};
