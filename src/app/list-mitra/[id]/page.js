...
import { DataTalentCard, HistoryTalentCard, BiodataField, MitraListCard, JobProviderCard } from "../../components/molecules";
...
const DataTalentDetail = () => {
  ...
  return (
    <Box className={styles["inbox-container"]}>
      ...
      <Text color='#AE445A' fontWeight={700} fontSize={20}>Job Provider</Text>
      <Gap height={2} />
