...
import { FormFields, ListEmpty, TalentListCard } from "../../components/molecules";
  ...
  return (
    <Box className={styles["inbox-container"]}>
      <Flex align={"center"} justify={"space-between"}>
        <Text className={styles["inbox-title"]}>List Mitra / Create Mitra Account</Text>
      </Flex>
      <Gap height={6} />
      <Box style={{ borderWidth: 1, borderColor: '#EAEAEA' }} />
      <Gap height={6} />
      <Flex>
        <FormFields theme="up-down" label="Nama" placeholder="Masukan nama mitra" />
        <Gap width={4} />
        <FormFields theme="up-down" label="Username" placeholder="Masukan username mitra" />
      </Flex>
      <Gap height={4} />
      <FormFields theme="up-down" label="E-Mail" placeholder="Masukan E-Mail mitra" />
      <Gap height={8} />
