      ...
      >
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          <Flex justify="space-between" alignItems="center">
            ...
            <Button className={styles['inbox-btn']}>View All</Button>
          </Flex>
          <Gap height={4} />
          <Flex
            borderWidth={1}
              ...
              <Box flex={1}>
                ...
                <Flex flex={1}>
                  <Box justifyContent="center" alignItems="center">
                    <Text color="#AE445A" fontWeight={600} fontSize={14}>
                      Diundang
                    </Text>
                    <Text
                      fontSize={14}
