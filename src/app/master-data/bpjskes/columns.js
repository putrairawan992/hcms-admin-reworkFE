...
const columns = (totalData, page) => {
  return [
    ...
    { name: 'NPP', selector: (row) => row.npp || '-', wrap: true, width: '185px' },
    { name: 'Hubungan Keluarga', selector: (row) => row.hubungan_keluarga || '-', wrap: true, width: '185px' },
    { name: 'Premi Karyawan', selector: (row) => formatRupiah(row.premi_karyawan), wrap: true, width: '185px' },
    { name: 'Premi Perusahaan', selector: (row) => formatRupiah(row.premi_perusahaan), wrap: true, width: '185px' },
    { name: 'Total Premi', selector: (row) => formatRupiah(row.total_premi), wrap: true, width: '185px' },
  ]
};
