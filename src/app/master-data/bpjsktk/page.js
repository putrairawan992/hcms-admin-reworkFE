...
import useBpjsktk from "./useBpjsktk";
...
const MasterDataBPJSKES = () => {
  ...
  const { data, page, totalData, keyword, onChangeText } = useBpjsktk();
        ...
        <Box style={{
          ...
          <Flex>
            ...
            <Box style={{
              ...
              justifyContent: 'center',
              cursor: 'pointer'
            }} onClick={() => router.push('/master-data/bpjsktk/batch')}>
