  ...
  return (
    ...
    >
      <Flex>
        ...
        <Gap width={2} />
        <Text color="#404041" fontWeight={400} fontSize={12}>
          Silahkan kerjakan rumus excel dengan panduan yang tersedia disini:
          https://google.com Beri nama file sesuai instruksi yang tersedia di
          link terkait.
        </Text>
      </Flex>
      <Gap height={4} />
